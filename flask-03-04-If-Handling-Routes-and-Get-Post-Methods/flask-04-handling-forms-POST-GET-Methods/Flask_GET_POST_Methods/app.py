...
# When the user comes directly "/calc" path, display the message "Since this is a GET request, LCM has not been calculated" string returns to them with "result.html" file
